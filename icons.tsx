...
export function FacebookIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M14 8.5V7a2 2 0 0 1 2-2h1.5V2.5H15a4.5 4.5 0 0 0-4.5 4.5v1.5H7.5V12h3v9.5h3.5V12h3l.8-3.5H14Z" />
    </svg>
  );
}
...
export function TikTokIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M14.5 3v10.5a3.5 3.5 0 1 1-3.5-3.5" />
      <path d="M14.5 3c.4 2.6 2 4.3 4.5 4.5" />
    </svg>
  );
}