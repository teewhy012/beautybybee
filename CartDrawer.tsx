                  ...
                  <div className="flex flex-1 flex-col justify-between py-0.5">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="text-xs text-cocoa underline-offset-2 hover:text-rose hover:underline"
                      >
                        Remove
                      </button>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center rounded-full border border-espresso/15">
                        <button
                          ...
                          className="h-8 w-8 rounded-full text-lg leading-none transition-colors hover:bg-white"
